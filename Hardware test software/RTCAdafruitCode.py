# needs to be tested - we don't want to use the terminal unless we have to
#(it takes an entire module and subprocesses to let the python program use the output)
